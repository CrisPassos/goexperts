...
func BuscaCepHandler(w http.ResponseWriter, r *http.Request) {
	...
	// chama a função BuscaCep passando o CEP
	...
	// converte o struct ViaCep para JSON e escreve na resposta
	// como eu só vou retornar o json eu não preciso usar o json.Marshal
