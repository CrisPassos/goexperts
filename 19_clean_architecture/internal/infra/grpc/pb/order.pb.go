...
const file_protofiles_order_proto_rawDesc = "" +
	"\n" +
	"\x16protofiles/order.proto\x12\x02pb\"\a\n" +
	"\x05blank\"L\n" +
	...
	"\fGetAllOrders\x12\t.pb.blank\x1a\x14.pb.GetOrderResponseB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
func file_protofiles_order_proto_rawDescGZIP() []byte {
	file_protofiles_order_proto_rawDescOnce.Do(func() {
		file_protofiles_order_proto_rawDescData = protoimpl.X.CompressGZIP([]byte(file_protofiles_order_proto_rawDesc))
	})
...
var file_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.GetOrderResponse.orders:type_name -> pb.Order
	...
	4, // 4: pb.OrderService.GetAllOrders:output_type -> pb.GetOrderResponse
...
func file_protofiles_order_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: []byte(file_protofiles_order_proto_rawDesc),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
